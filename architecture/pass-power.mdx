---
title: "PassPower: EDI Interception and Rescaling Logic"
sidebarTitle: "Pass Power"
description: "How CalculateModifiedEDI rescales the raw pass power value using inertia classification, distance-based boost tables, soft floors, and geometric awkward-angle rescue."
---
...
| Value | Meaning |
|---|---|
| `0x00` | No change applied (strong pass or mod off) |
