...
description: "How the BallInertiaBand enum classifies ball energy at pass time into five categories, and how each band receives different boost magnitudes in the lookup tables."
---
